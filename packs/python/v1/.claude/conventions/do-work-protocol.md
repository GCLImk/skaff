...
├── scout/                          python-scout findings briefs
...
| `do-work/scout/`             | No        | No                  | python-scout only         |
...
| Writing the `## Plan` section into the REQ file        | python-implement (plan-only mode) |
| Writing the `## Plan Hash` section into the REQ file   | python-implement agent |
...
| Writing code under `src/` and `tests/`                 | python-implement agent |
| XML doc and markdown edits                             | python-doc-writer agent|
| Scout findings under `do-work/scout/`                  | python-scout agent     |
...
- Agents must not edit the `## Plan Hash` section. It is owned by python-implement and is the drift-detection anchor.
