...
├── scout/                          html-css-scout findings briefs
...
| `do-work/scout/`             | No        | No                  | html-css-scout only         |
...
| Writing the `## Plan` section into the REQ file        | html-css-implement (plan-only mode) |
| Writing the `## Plan Hash` section into the REQ file   | html-css-implement agent |
...
| Writing code under `index.html`, `src/`, `public/`, and `tests/` | html-css-implement agent |
| JSDoc and markdown edits                               | html-css-doc-writer agent|
| Scout findings under `do-work/scout/`                  | html-css-scout agent     |
...
- Agents must not edit the `## Plan Hash` section. It is owned by html-css-implement and is the drift-detection anchor.
