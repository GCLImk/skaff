...
**Handoff**
- Main session routes on verdict: Approve → ratchet (then git-workflow if Kept), Request Changes → html-css-implement, Escalate → user
...
4. Check semantic HTML, keyboard access, focus visibility, accessible names, responsive behaviour, CSS architecture coherence, and README or JSDoc updates when they were in scope.
