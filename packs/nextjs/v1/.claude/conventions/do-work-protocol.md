...
├── scout/                          nextjs-scout findings briefs
...
| `do-work/scout/`             | No        | No                  | nextjs-scout only         |
...
| Writing the `## Plan` section into the REQ file        | nextjs-implement (plan-only mode) |
| Writing the `## Plan Hash` section into the REQ file   | nextjs-implement agent |
...
| Writing code under `src/` and `tests/`                 | nextjs-implement agent |
| XML doc and markdown edits                             | nextjs-doc-writer agent|
| Scout findings under `do-work/scout/`                  | nextjs-scout agent     |
...
- Agents must not edit the `## Plan Hash` section. It is owned by nextjs-implement and is the drift-detection anchor.
