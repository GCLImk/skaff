...
name: git-workflow
description: >
  Manage git operations and GitHub PR lifecycle. Activate when the user asks to
  commit, push, open a PR, or manage branches. Enforces GitHub Flow and
  Conventional Commits. Scans for secrets before every commit.
---
