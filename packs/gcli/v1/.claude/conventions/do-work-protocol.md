...
├── scout/                          gcli-scout findings briefs
...
| `do-work/scout/`             | No        | No                  | gcli-scout only         |
...
| Writing the `## Plan` section into the REQ file        | gcli-implement (plan-only mode) |
| Writing the `## Plan Hash` section into the REQ file   | gcli-implement agent |
...
| Writing code under `src/` and `tests/`                 | gcli-implement agent |
| XML doc and markdown edits                             | gcli-doc-writer agent|
| Scout findings under `do-work/scout/`                  | gcli-scout agent     |
...
- Agents must not edit the `## Plan Hash` section. It is owned by gcli-implement and is the drift-detection anchor.
