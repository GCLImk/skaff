...
**Handoff**
- Main session routes on verdict: Approve -> ratchet (then git-workflow if Kept), Request Changes -> svelte-implement, Escalate -> user
...
5. Test realism means Svelte Testing Library coverage of user-visible behavior, accessible queries where practical, and `user-event` for interactions instead of implementation-detail assertions.
