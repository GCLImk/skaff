...
description: Audits design-system and Storybook changes for WCAG 2.1 AA, keyboard support, focus management, accessible names, contrast, and motion safety. Use proactively when the user asks about accessibility, keyboard flows, ARIA, contrast, or screen-reader behaviour.
tools:
  - Read
  - Grep
  - Glob
...
- [ ] Storybook accessibility assumptions called out when relevant
