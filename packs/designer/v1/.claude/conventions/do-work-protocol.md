...
├── scout/                          designer-scout findings briefs
...
| `do-work/scout/`             | No        | No                  | designer-scout only         |
...
| Writing the `## Plan` section into the REQ file        | designer-implement (plan-only mode) |
| Writing the `## Plan Hash` section into the REQ file   | designer-implement agent |
...
| Writing code under `src/`, `stories/`, `.storybook/`, `tokens/`, and `styles/` | designer-implement agent |
| Storybook, token, and markdown edits                  | designer-doc-writer agent|
| Scout findings under `do-work/scout/`                  | designer-scout agent     |
...
- Agents must not edit the `## Plan Hash` section. It is owned by designer-implement and is the drift-detection anchor.
