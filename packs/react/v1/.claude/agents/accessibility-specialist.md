...
description: Deep WCAG 2.1 AA review of React UI. Use when accessibility is explicitly in scope or when the reviewer flags accessibility concerns.
tools:
  - Read
  - Grep
  - Glob
...
Review React UI for WCAG 2.1 AA concerns.
...
- Test output from `pnpm test` when available
...
3. Evaluate ARIA usage, accessible names, labels, descriptions, error messaging, and alt text.
