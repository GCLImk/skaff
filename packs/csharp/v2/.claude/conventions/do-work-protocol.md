...
├── scout/                          csharp-scout findings briefs
...
| `do-work/scout/`             | No        | No                  | csharp-scout only         |
...
| Writing the `## Plan` section into the REQ file        | csharp-implement (plan-only mode) |
| Writing the `## Plan Hash` section into the REQ file   | csharp-implement agent |
...
| Writing code under `src/` and `tests/`                 | csharp-implement agent |
| XML doc and markdown edits                             | csharp-doc-writer agent|
| Scout findings under `do-work/scout/`                  | csharp-scout agent     |
...
- Agents must not edit the `## Plan Hash` section. It is owned by csharp-implement and is the drift-detection anchor.
