...
**Inputs**
- REQ file content or audit scope from orchestrator
...
8. Run `dotnet build` after editing any `.cs` files. Resolve all CS1591 warnings before committing.
9. Commit messages follow Conventional Commits: `docs(scope): description`.
...
- [ ] Changes committed with Conventional Commits message
