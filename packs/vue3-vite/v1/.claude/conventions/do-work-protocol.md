...
├── scout/                          vue3-scout findings briefs
...
| `do-work/scout/`             | No        | No                  | vue3-scout only         |
...
| Writing the `## Plan` section into the REQ file        | vue3-implement (plan-only mode) |
| Writing the `## Plan Hash` section into the REQ file   | vue3-implement agent |
...
| Writing code under `src/` and `tests/`                 | vue3-implement agent |
| XML doc and markdown edits                             | vue3-doc-writer agent|
| Scout findings under `do-work/scout/`                  | vue3-scout agent     |
...
- Agents must not edit the `## Plan Hash` section. It is owned by vue3-implement and is the drift-detection anchor.
